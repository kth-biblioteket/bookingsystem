...
(1, 'email', 2,'custom', 200, 1, 1, 0, 1),
(1, 'phone', 2,'custom', 300, 1, 1, 0, 1),
(1, 'user_group', 2,'custom', 150, 1, 0, 0, 1),
(1, 'campus', 6,'custom', 410, 1, 1, 0, 1),
(1, 'program', 3,'custom', 500, 1, 1, 0, 1),
(1, 'consultation_info', 3,'custom', 600, 1, 1, 0, 1),
(1, 'study_info', 3,'custom', 600, 1, 1, 0, 1),
(1, 'previously', 3,'custom', 700, 1, 1, 0, 1),
(1, 'subject_keywords', 3,'custom', 800, 1, 1, 0, 1),
(1, 'instructor', 6,'custom', 400, 1, 1, 0, 1),
(1, 'preferred_language', 2,'custom', 420, 1, 1, 0, 1),
(1, 'start_time', 1,'standard', 100, 1, 1, 0, 1),
(1, 'end_time', 1,'standard', 101, 1, 1, 0, 1),
(1, 'name', 2,'standard', 140, 1, 1, 0, 1);
...
--Grupprum/lässtudio
INSERT INTO `kth_entry_custom_fields` (`area_id`, `entry_field_name`, `field_type`, `type`, `sort_order`, `visible`, `enabled`, `user_hidden`, `mandatory`) VALUES
(1, 'name', 2, 'standard', 110, 1, 1, 0, 1),
(1, 'description', 2, 'standard', 115, 1, 1, 0, 1),
(1, 'start_time', 1, 'standard', 100, 1, 1, 0, 1),
(1, 'end_time', 1, 'standard', 105, 1, 1, 0, 1),
(1, 'confirmation_status', 0, 'standard', 130, 1, 1, 0, 1);
...
--Talbok,inläsningstjänst
INSERT INTO `kth_places` (`disabled`, `default_choice`, `room_id`, `sort_key`, `name`, `name_en`) VALUES
(0, 1, 1, '3', 'KTH Biblioteket, Huvudbiblioteket', 'KTH Library, Main library'),
(0, 1, 1, '2', 'Distans, Zoom', 'Distance, Zoom'),
(0, 1, 1, '1', '1none', '1none');

--CAS OBS cas har två rum!
INSERT INTO `kth_places` (`disabled`, `room_id`, `sort_key`, `name`, `name_en`) VALUES
(0, 1, 1, '3', 'KTH Biblioteket, Huvudbiblioteket', 'KTH Library, Main library'),
(0, 1, 1, '2', 'Distans, Zoom', 'Distance, Zoom'),
(0, 1, 1, '1', '1none', '1none'),
(0, 2, 1, '3', 'KTH Biblioteket, Huvudbiblioteket', 'KTH Library, Main library'),
(0, 2, 1, '2', 'Distans, Zoom', 'Distance, Zoom'),
(0, 2, 1, '1', '1none', '1none');
